...
namespace TUGAS2.Classes
{
    abstract class Robot
    {
        ...
        public abstract void diserang(int serangan, string penyerang);
    }
    class NormalRobot : Robot
    {
        ...
        {
            target.diserang(this.serangan, this.nama);
        ...
        public override void diserang(int jmlSerangan, string penyerang)
        {
            int totalDamage = jmlSerangan - this.armor;
            if (totalDamage <= 0) { totalDamage = 0; }
            this.energi -= totalDamage;
            if (this.energi <= 0) { this.energi = 0; mati(); }
        }
        public void mati()
        {
